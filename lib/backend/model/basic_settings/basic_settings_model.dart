...
//
//     final basicSettingsInfoModel = basicSettingsInfoModelFromJson(jsonString);


import 'dart:convert';

BasicSettingsInfoModel basicSettingsInfoModelFromJson(String str) => BasicSettingsInfoModel.fromJson(json.decode(str));

String basicSettingsInfoModelToJson(BasicSettingsInfoModel data) => json.encode(data.toJson());
