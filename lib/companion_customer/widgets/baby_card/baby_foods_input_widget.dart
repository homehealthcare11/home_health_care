...
class InputFieldWidgetProfileBaby extends StatefulWidget {
  ...
  const InputFieldWidgetProfileBaby({
    Key? key,
  ...
  @override
  State<InputFieldWidgetProfileBaby> createState() =>
      _InputFieldWidgetProfileBabyState();
}

class _InputFieldWidgetProfileBabyState
    extends State<InputFieldWidgetProfileBaby> {
  FocusNode? focusNode;
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintText: controller.getTranslation(widget.hint),
