...
import '../../controller/add_pet/upload_pet_image_controller.dart';
import '../../custom_assets/assets.gen.dart';
import '../../utils/basic_screen_imports.dart';
import '../others/custom_image_widget.dart';

File? imageFile;
final imgController = Get.put(UploadPetImageController());
...
// ignore: must_be_immutable
class PetPictureUpload extends StatefulWidget {
  PetPictureUpload({super.key, this.image, required this.title});

  File? image;
  String title;

  @override
  State<PetPictureUpload> createState() => _PetPictureUploadState();
}

class _PetPictureUploadState extends State<PetPictureUpload> {
  @override
