...
class CongratulationScreenSignInMobileResponsive extends StatelessWidget {
  const CongratulationScreenSignInMobileResponsive({
    super.key,
  });
        ...
        child: Column(
          ...
          children: [
            ...
            TitleHeading3Widget(
              ...
              text: Strings.signInCongratulationDes.tr,
              padding: EdgeInsets.only(
