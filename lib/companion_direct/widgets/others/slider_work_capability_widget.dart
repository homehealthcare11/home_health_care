...
class SliderCapabilityWidget extends StatefulWidget {
  final double sliderPointerValue;
  final List<String> dataRanges;

  const SliderCapabilityWidget({
    Key? key,
  ...
  @override
  State<SliderCapabilityWidget> createState() => _SliderCapabilityWidgetState();
}

class _SliderCapabilityWidgetState extends State<SliderCapabilityWidget> {
          ...
          children: [
            SfSlider(
              ...
              onChanged: (dynamic value) {
                setState(() {
                  _sliderPointerValue = value;
                  controller.sliderValueCapability = _sliderPointerValue.obs;
                });
