...
class SliderAgeWidget extends StatefulWidget {
  final double sliderPointerValue;
  final List<String> dataRanges;

  const SliderAgeWidget({
    Key? key,
  ...
  @override
  State<SliderAgeWidget> createState() => _SliderAgeWidgetState();
}

class _SliderAgeWidgetState extends State<SliderAgeWidget> {
          ...
          children: [
            SfSlider(
              ...
              onChanged: (dynamic value) {
                setState(() {
                  _sliderPointerValue = value;
                  controller.sliderValueAge = _sliderPointerValue.obs;
                });
