...
class SliderWidgetAge extends StatefulWidget {
  final double sliderPointerValue;
  final List<String> dataRanges;

  const SliderWidgetAge({
    Key? key,
  ...
  @override
  State<SliderWidgetAge> createState() => _SliderWidgetState();
}

class _SliderWidgetState extends State<SliderWidgetAge> {
