...
import '../../../backend/model/companion_direct_money_out/money_out_info_model.dart';
import '/backend/model/companion_direct_money_out/money_out_model.dart';

import '../../../backend/model/common/common_success_model.dart';
import '../../../backend/services/money_out_api_services.dart';
import '../../../companion_customer/congratulation/congratulation_screen.dart';
import '../../../companion_customer/routes/routes.dart';
import '../../utils/basic_widget_imports.dart';
import '../../widgets/money_out/primary_input_widget.dart';
import '../../widgets/money_out_image_picker.dart';
...
class MoneyOutController extends GetxController {
  ...
  List<String> allCurrencyList = [];
  List<String> allCurrencyAliasList = [];
...
//money out insert process
  ...
  late NannyMoneyOutModel _moneyOutInsertModel;

  NannyMoneyOutModel get moneyOutInsertModel => _moneyOutInsertModel;

  ///* A -dd Money manual insert api process start
  Future<NannyMoneyOutModel> manualPaymentGetGatewaysProcess() async {
